		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax"></div>
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control delete" id="nombre" name="nombre" required>
				</div>
			  </div>
			  <div class="form-group">
				<label for="telefono" class="col-sm-3 control-label">Teléfono</label>
				<div class="col-sm-8">
				  <input type="text" class="form-control delete" id="telefono" name="telefono" >
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
					<input type="email" class="form-control delete" id="email" name="email" >
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
					<textarea class="form-control delete" id="direccion" name="direccion"   maxlength="255" ></textarea>
