    ...
    $direccion_ = ($_SESSION['idsucursal'] == 50 ) ? 'Jr. Ancash 848-Huari-Ancash' : 'Av. 25 de Enero lote 5 -Urb. Santa Luisa -Infantas';
      ...
      $html.='<tr style="border: 1px solid black;">
       ...
       <tr >
        ...
        <table style="width: 99.2%; background-color: white; font-size:11px; text-align: left;border-collapse: collapse;border: 1px solid black;">
                <tr>
                  <td style="">FECHA:</td>
                  <td>'.$_GET["fecha"].'</td>
        ...
        <table style="width: 100%; font-size:11px;  text-align: center;border-collapse: collapse;border: 1px solid black;">
      ...
      $queryquery = "SELECT SUBSTRING(a.n_documento,1,4) serie,SUBSTRING(a.n_documento,6,13) numero,SUBSTRING(b.descripccion,8,1) piso, SUBSTRING(b.descripccion,19,3) asiento,su.nombre_sucursal, d.id_tipo_persona, d.edad, b.descripccion, d.nombre_cliente, d.n_documento_identidad, a.n_documento, a.precio_total  FROM tb_facturacion_cab a
